...
type CharacterAnswerAccuracy = {
  ...
  statMaterialAccuracy: AnswerOptions;
  localAscensionAccuracy: AnswerOptions;
  bookTalentAccuracy: AnswerOptions;
  birthdayAccuracy: AnswerOptions;
};

export default CharacterAnswerAccuracy;
